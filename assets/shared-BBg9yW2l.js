import{S as e,at as t,p as n}from"./index-B29KcSrC.js";import{a as r,r as i}from"./share-Df8piYTe.js";async function a(a,o){let s=location.hash.match(/quiz=([^&]+)/);if(!s){o.go(`library`);return}let c;try{c=await i(decodeURIComponent(s[1]))}catch(t){a.innerHTML=`
