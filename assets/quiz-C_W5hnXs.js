import{n as e}from"./topics-2sMjMAqj.js";import{t}from"./assets-C7X78vgS.js";import{E as n,G as r,H as i,S as a,W as o,c as s,dt as c,gt as l,it as u,j as ee,k as d,p as f,q as p,rt as m}from"./index-B29KcSrC.js";import{r as h}from"./gemini-Cd7CzOeY.js";import{n as te,r as g}from"./quiz-ai-dV1Jaejn.js";import{t as _}from"./explain-CQoRFyIV.js";import{t as v}from"./imgZoom-BMtI0Ckh.js";function y(e){return JSON.stringify([e.count,e.mix,e.difficulty,e.shuffle,e.timerSec,e.fresh,e.topics,!!e.ai,!!e.focusWeak])}function b(){return`quizard-active-quiz-${x()}`}function x(){return window.__quizAccountId||`default`}function S(e,t,n){if(!(t.mistakeMode||!e))try{localStorage.setItem(b(),JSON.stringify({docId:e.id,docName:e.name,questions:n,index:t.index,correct:t.correct,answers:t.answers,savedAt:Date.now()}))}catch{}}function C(){localStorage.removeItem(b())}function ne(e,t){e.innerHTML=`
