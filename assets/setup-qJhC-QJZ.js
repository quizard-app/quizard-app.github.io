import{t as e}from"./topics-CMOvnQe4.js";import{E as t,H as n,K as r,O as i,S as a,k as o,p as s,x as c,y as l}from"./index-CFOjCPH8.js";import{r as u}from"./gemini-oEREmi_K.js";import{i as d}from"./quiz-ai-F1sgvzMi.js";import{t as f}from"./shareModal-Ca6Zr7Z2.js";var p=[`mcq`,`tf`,`fib`,`id`,`matching`,`ordering`,`short`,`except`,`multi`],m=!1;function h(){m=!1}async function g(h,g){m=!0;let b=await n(g.state.currentDocId);if(!b||!m){g.go(`library`);return}let x=g.getConfig(b.id),S=x.count,C={...x.mix},w=x.difficulty,T=x.shuffle,E=x.timerSec,D=x.fresh,O=x.ai!==!1,k=O&&x.aiAuthor===!0,A=!!x.focusWeak,j=x.deepVisual!==!1,M=Array.isArray(b.topics)&&b.topics.length?b.topics:e(b.text).topics,N=new Set(x.topics||[]),P=i(b,{...x,topics:[...N]});S>P&&(S=Math.max(1,P)),h.innerHTML=`
