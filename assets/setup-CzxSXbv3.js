import{t as e}from"./topics-CMOvnQe4.js";import{E as t,H as n,K as r,O as i,S as a,k as o,p as s,x as c,y as l}from"./index-DUeJPbcj.js";import{a as u,i as d}from"./gemini-Bv9es_do.js";import{i as f}from"./quiz-ai-DkFqW9pl.js";import{t as p}from"./shareModal-DHapW4jf.js";var m=[`mcq`,`tf`,`fib`,`id`,`matching`,`ordering`,`short`,`except`,`multi`],h=!1;function g(){h=!1}async function _(g,_){h=!0;let x=await n(_.state.currentDocId);if(!x||!h){_.go(`library`);return}let S=_.getConfig(x.id),C=S.count,w={...S.mix},T=S.difficulty,E=S.shuffle,D=S.timerSec,O=S.fresh,k=S.ai!==!1,A=k&&S.aiAuthor===!0,j=!!S.focusWeak,M=S.deepVisual!==!1,N=Array.isArray(x.topics)&&x.topics.length?x.topics:e(x.text).topics,P=new Set(S.topics||[]),F=i(x,{...S,topics:[...P]});C>F&&(C=Math.max(1,F)),g.innerHTML=`
