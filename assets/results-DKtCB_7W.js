const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B29KcSrC.js","assets/topics-2sMjMAqj.js","assets/assets-C7X78vgS.js","assets/index-D_wIOZq8.css","assets/mistakes-bfbiOqik.js"])))=>i.map(i=>d[i]);
import{i as e}from"./topics-2sMjMAqj.js";import{$ as t,E as n,K as r,S as i,et as a,n as o,p as s,rt as c,y as l}from"./index-B29KcSrC.js";import{startMistakeReview as u,startWeakReview as d}from"./mistakes-bfbiOqik.js";import{r as f}from"./gemini-Cd7CzOeY.js";import{r as p}from"./export-DdJB2-fg.js";import{t as m}from"./explain-CQoRFyIV.js";import{t as h}from"./shareModal-BfXdkSBi.js";async function g(g,y){let b=y.state.lastResult;if(!b){y.go(`library`);return}let x=f()&&c().aiExplain!==!1,S=y.state.challenge||b.challenge||null,C=0,w=0;try{let[e,t]=await Promise.all([r(null),a(60)]);C=e.length,w=t.length}catch{}let T=null;try{let{getDoc:n}=await o(async()=>{let{getDoc:e}=await import(`./index-B29KcSrC.js`).then(e=>e.pt);return{getDoc:e}},__vite__mapDeps([0,1,2,3])),r=(await t()).filter(e=>e.id!==b.docId),i=new Set(e(b.review?.map(e=>e.correct).join(`. `)||``).map(e=>e.term.toLowerCase()).slice(0,12));if(i.size){let t=null;for(let a of r.slice(0,12)){let r=await n(a.id).catch(()=>null);if(!r?.text)continue;let o=new Set(e(r.text).map(e=>e.term.toLowerCase()).slice(0,16)),s=0;for(let e of i)o.has(e)&&s++;(!t||s>t.overlap)&&(t={doc:{...a},overlap:s})}t&&t.overlap>=2&&(T=t)}}catch{}let E=b.percent>=90?[`Outstanding!`,`You have mastered this material.`]:b.percent>=75?[`Great job!`,`Solid understanding — review the misses to perfect it.`]:b.percent>=50?[`Good effort`,`A quick review will push you higher.`]:[`Keep practicing`,`Revisit the document and try again.`];g.innerHTML=`
    <div class="screen">
