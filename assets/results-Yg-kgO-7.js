const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CFOjCPH8.js","assets/topics-CMOvnQe4.js","assets/assets-CzjTyYhp.js","assets/index-DYmnPHeG.css","assets/mistakes-APsK6FZt.js"])))=>i.map(i=>d[i]);
import{o as e}from"./topics-CMOvnQe4.js";import{$ as t,E as n,K as r,S as i,et as a,n as o,p as s,rt as c,y as l}from"./index-CFOjCPH8.js";import{startMistakeReview as u,startWeakReview as d}from"./mistakes-APsK6FZt.js";import{r as f}from"./gemini-oEREmi_K.js";import{r as p}from"./export-CPaDU7nh.js";import{t as m}from"./explain-CJjGZwSQ.js";import{t as h}from"./shareModal-Ca6Zr7Z2.js";async function g(g,y){let b=y.state.lastResult;if(!b){y.go(`library`);return}let x=f()&&c().aiExplain!==!1,S=y.state.challenge||b.challenge||null,C=0,w=0;try{let[e,t]=await Promise.all([r(null),a(60)]);C=e.length,w=t.length}catch{}let T=null;try{let{getDoc:n}=await o(async()=>{let{getDoc:e}=await import(`./index-CFOjCPH8.js`).then(e=>e.pt);return{getDoc:e}},__vite__mapDeps([0,1,2,3])),r=(await t()).filter(e=>e.id!==b.docId),i=new Set(e(b.review?.map(e=>e.correct).join(`. `)||``).map(e=>e.term.toLowerCase()).slice(0,12));if(i.size){let t=null;for(let a of r.slice(0,12)){let r=await n(a.id).catch(()=>null);if(!r?.text)continue;let o=new Set(e(r.text).map(e=>e.term.toLowerCase()).slice(0,16)),s=0;for(let e of i)o.has(e)&&s++;(!t||s>t.overlap)&&(t={doc:{...a},overlap:s})}t&&t.overlap>=2&&(T=t)}}catch{}let E=b.percent>=90?[`Outstanding!`,`You have mastered this material.`]:b.percent>=75?[`Great job!`,`Solid understanding — review the misses to perfect it.`]:b.percent>=50?[`Good effort`,`A quick review will push you higher.`]:[`Keep practicing`,`Revisit the document and try again.`];g.innerHTML=`
