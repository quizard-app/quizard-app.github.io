import{t as e}from"./topics-C-V_Y0ip.js";import{E as t,H as n,K as r,O as i,S as a,k as o,p as s,x as c,y as l}from"./index-9KzczjfU.js";import{r as u}from"./gemini-Cd7CzOeY.js";import{n as d}from"./quiz-ai-CBPbotHz.js";import{t as f}from"./shareModal-BgmOZVvr.js";var p=[`mcq`,`tf`,`fib`,`id`,`matching`,`ordering`,`short`];async function m(m,v){let y=await n(v.state.currentDocId);if(!y){v.go(`library`);return}let b=v.getConfig(y.id),x=b.count,S={...b.mix},C=b.difficulty,w=b.shuffle,T=b.timerSec,E=b.fresh,D=b.ai!==!1,O=!!b.focusWeak,k=b.deepVisual!==!1,A=Array.isArray(y.topics)&&y.topics.length?y.topics:e(y.text).topics,j=new Set(b.topics||[]),M=i(y,{...b,topics:[...j]});x>M&&(x=Math.max(1,M)),m.innerHTML=`
