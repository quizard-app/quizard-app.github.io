    ...
    <div class="screen">
      ...
      <div id="result-stage" class="hidden">
        <div class="card" style="margin-top:10px">
          ...
          <datalist id="folder-list">${m.map(e=>`<option value="${s(e)}"></option>`).join(``)}</datalist>
