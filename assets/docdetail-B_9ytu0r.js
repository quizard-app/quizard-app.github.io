import{$ as e,H as t,L as n,S as r,b as i,d as a,ht as o,m as s,p as c,r as l,u,vt as d,x as f,y as p}from"./index-BgmxL5Y0.js";import{r as m}from"./gemini-DfbjurkX.js";import{n as h}from"./quiz-ai-BCJx6jsX.js";async function g(g,_){let v=await t(_.state.currentDocId);if(!v){_.go(`library`);return}let y=Array.isArray(v.topics)?v.topics:[],b=d(await e()).filter(e=>e!==v.folder);g.innerHTML=`
