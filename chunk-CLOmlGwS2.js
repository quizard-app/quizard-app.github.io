import{n as r,r as s}from"./chunk-CCnQ1X3m.js";import"./chunk-Dqyvoa3d.js";import"./chunk-hh0W7bTI.js";import"./chunk-BGoW8wMh.js";import"./chunk-D4k-zadY.js";import"./chunk-DEURnQ86.js";import"./chunk-CABSGZFi.js";import"./chunk-tv0E5ky_.js";import{$t as qg,Cn as yw,Dt as gm,En as zt,Et as g,F as Ol,G as Tw,K as Uf,Kt as nm,N as Nl,S as JI,Tt as fm,Ut as mm,V as Ra,Vt as mS,Xt as pS,_n as xs,a as Bg,c as Cl,dt as bb,en as rS,et as Ws,in as sw,m as Ew,pt as bw,q as Ug,qt as nr,sn as uI,ut as aw,v as Hf,vn as yE,vt as dm,w as Jw,xt as eC,z as Qg}from"./chunk-DNNweo43.js";import{r as Ta}from"./chunk-DPg3xbaC.js";import{I as Kt,X as Z,c as h,i as p,o as d,p as j,s as a,ut as me,vt as tt,wt as zt$1}from"./main-IWUVVWL3.js";import{a as M,l as X}from"./chunk-BiM_qOS_.js";import{d as at,o as Oe$1}from"./chunk-OenFUPh_.js";import{t as a$1}from"./chunk-D6aT4yUI.js";import{n as Ot,o as on,s as un,t as Ie$1}from"./chunk-oL0wvA0A.js";import"./chunk-Dqt6NRMF.js";import{t as n}from"./chunk-BxT9_UAb.js";import{t as a$2}from"./chunk-CCPKOP-2.js";import{t as B}from"./chunk-C9txRCag.js";import{a as q,r as V,t as K}from"./chunk-qdysQK2L.js";var Pe=14e3;var Ee=`You are an expert exam reviewer writer. Read the DOCUMENT and produce a complete exam reviewer in strict JSON \u2014 the kind a top student would write by hand to cram from.
...
${n[s]}`;try{let a=await j(`${Ee}

${h}`,{json:!0,maxOutputTokens:8e3,temperature:.3,timeoutMs:95e3}),p;try{p=JSON.parse(a)}catch{let o=a.match(/\{[\s\S]*\}/);if(o)try{p=JSON.parse(o[0])}catch{p=null}}if(l=Ie(p),l&&(m=s),!l&&n.length>1)try{l=Ie(JSON.parse(await j(`${Ee}

${h}

Return ONLY valid JSON.`,{json:!0,maxOutputTokens:8e3,temperature:.2,timeoutMs:95e3})))}catch{}}catch(a){let p=String(a?.message||a);if(p.includes(`no_keys_configured`)||p.includes(`origin_not_allowed`))return{error:`relay_unavailable`};/timeout|upstream_timeout|504|abort/i.test(p)&&(c=!0)}}if(!l)return{error:c?`timeout`:`generation_failed`};if(n.length>1){let s$1=Array.isArray(l.gaps)?l.gaps:[];s$1.unshift(`This file is long \u2014 the reviewer was built from part ${m+1} of ${n.length}; later sections may be missing.`),l=s(r({},l),{gaps:s$1.slice(0,6)})}try{await zt$1(r$1.id,{reviewerAI:l})}catch{}return{reviewer:l,cached:!1}}function Le(r,e){let i=e,t=[];t.push(`
    <div class="rvw-head">
