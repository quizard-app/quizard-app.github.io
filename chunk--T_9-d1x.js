import{n as r,r as s}from"./chunk-CCnQ1X3m.js";import"./chunk-Dqyvoa3d.js";import"./chunk-hh0W7bTI.js";import"./chunk-CNHhRfyH.js";import"./chunk-D4k-zadY.js";import"./chunk-DEURnQ86.js";import"./chunk-CABSGZFi.js";import"./chunk-tv0E5ky_.js";import{$t as qg,Cn as yw,Dt as gm,En as zt,Et as g,F as Ol,G as Tw,K as Uf,Kt as nm,N as Nl,S as JI,Tt as fm,Ut as mm,V as Ra,Vt as mS,Xt as pS,_n as xs,a as Bg,c as Cl,dt as bb,en as rS,et as Ws,in as sw,m as Ew,pt as bw,q as Ug,qt as nr,sn as uI,ut as aw,v as Hf,vn as yE,vt as dm,w as Jw,xt as eC,z as Qg}from"./chunk-DNNweo43.js";import{r as Ta}from"./chunk-B7FLwtU1.js";import{$ as me,St as j,T as Kt,_t as h,gt as a,ht as d,i as p$1,pt as zt$1,st as tt,z as Z}from"./main-TBNN6V35.js";import{a as M,l as X}from"./chunk-BiM_qOS_.js";import{t as B}from"./chunk-C9txRCag.js";import{n as Ot,o as on,s as un,t as Ie}from"./chunk-oL0wvA0A.js";import{t as n}from"./chunk-BxT9_UAb.js";import{d as at,o as Oe$1}from"./chunk-OenFUPh_.js";import{t as a$1}from"./chunk-CCPKOP-2.js";import{t as a$2}from"./chunk-D6aT4yUI.js";import"./chunk-Dqt6NRMF2.js";import{a as Y$1,i as X$1,n as K$1,t as J}from"./chunk-DeUf9GtK2.js";var Le=14e3;var Ve=`You are an expert exam reviewer writer. Read the DOCUMENT and produce a complete exam reviewer in strict JSON \u2014 the kind a top student would write by hand to cram from.
...
Return ONLY valid JSON.`,{json:!0,maxOutputTokens:8e3,temperature:.2,timeoutMs:95e3})))}catch{}}catch(h){let a=String(h?.message||h);if(a.includes(`no_keys_configured`)||a.includes(`origin_not_allowed`))return{error:`relay_unavailable`};/timeout|upstream_timeout|504|abort/i.test(a)&&(c=!0)}}if(!o)return{error:c?`timeout`:`generation_failed`};if(n.length>1){let l=Array.isArray(o.gaps)?o.gaps:[];l.unshift(`This file is long \u2014 the reviewer was built from part ${d+1} of ${n.length}; later sections may be missing.`),o=s(r({},o),{gaps:l.slice(0,6)})}try{await zt$1(r$1.id,{reviewerAI:o})}catch{}return{reviewer:o,cached:!1}}function De(r,i){let e=i,t=[];t.push(`
    <div class="rvw-head">
      ...
      <div class="rvw-part">
        <div class="rvw-part-head"><span class="rvw-num">${Fe(o)}</span><h3>${e(m)}</h3></div>`);for(let s of a.sections){t.push(`<div class="ai-sec">`);let w=s.mustKnow?`<span class="ai-flag ${/VERY/i.test(s.mustKnow)?`hot`:/Important/i.test(s.mustKnow)?`warm`:`cool`}">${e(s.mustKnow)}</span>`:``,C=s.stars?`<span class="ai-stars">`+`⭐`.repeat(Math.min(3,s.stars))+`</span>`:``;if(t.push(`<div class="ai-sec-head"><span class="ai-num">${e(s.num)}</span><h4>${e(s.heading)}${C}</h4>${w}</div>`),s.definition){let f=s.definition.indexOf(`=`);t.push(f>0?`<p class="ai-def"><span class="ai-def-term">${e(s.definition.slice(0,f).trim())}</span> = ${e(s.definition.slice(f+1).trim())}</p>`:`<p class="ai-def">${e(s.definition)}</p>`)}s.explanation&&t.push(`<p class="ai-expl" data-para>${e(s.explanation)}</p>`);for(let f of s.terms||[]){if(t.push(`<div class="ai-term" data-para>`),t.push(`<div class="ai-term-name">\u{1F539} ${e(f.term)}</div>`),f.meaning){let R=f.meaning.replace(/^meaning:\s*/i,``);t.push(`<p class="ai-term-meaning"><span class="ai-term-label">Meaning:</span> ${e(R)}</p>`)}f.bullets&&f.bullets.length&&t.push(`<ul class="ai-bullets">${f.bullets.map(R=>`<li data-para>${K(R,e)}</li>`).join(``)}</ul>`),f.memory&&t.push(`<div class="ai-box ai-memory"><span class="ai-box-label">Memory</span><span>${e(f.memory)}</span></div>`),t.push(`</div>`)}let P=s.bullets||[],N=s.steps||[];P.length&&t.push(`<ul class="ai-bullets">${P.map(f=>`<li data-para>${K(f,e)}</li>`).join(``)}</ul>`),N.length&&t.push(`<ol class="ai-steps">${N.map(f=>`<li data-para>${K(f,e)}</li>`).join(``)}</ol>`),s.table&&t.push(`<table class="ai-table"><thead><tr>${s.table.headers.map(f=>`<th>${e(f)}</th>`).join(``)}</tr></thead><tbody>${s.table.rows.map(f=>`<tr>${f.map(R=>`<td>${e(R)}</td>`).join(``)}</tr>`).join(``)}</tbody></table>`),s.mnemonic&&t.push(`<div class="ai-mnemonic" data-para><span class="ai-mnemonic-label">\u{1F9E0} Memorize</span><span>${e(s.mnemonic)}</span></div>`),s.important&&t.push(`<div class="ai-box ai-important" data-para><span class="ai-box-label">Important</span><span>${e(s.important)}</span></div>`),s.example&&t.push(`<div class="ai-box ai-example" data-para><span class="ai-box-label">Example</span><span>${e(s.example)}</span></div>`),s.memory&&t.push(`<div class="ai-box ai-memory" data-para><span class="ai-box-label">Memory trick</span><span>${e(s.memory)}</span></div>`),s.examClue&&t.push(`<div class="ai-box ai-clue" data-para><span class="ai-box-label">Exam clue</span><span>${e(s.examClue)}</span></div>`),t.push(`</div>`)}t.push(`</div>`)}let d=r.highYield||[];d.length&&t.push(`
      <div class="rvw-part">
